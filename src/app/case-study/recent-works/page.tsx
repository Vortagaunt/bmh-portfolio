...
const photos: (ZoomItem & { ratio: "square" | "wide" | "tall" | "portrait" | "poster" | "banner" })[] = [
  // Posters / portraits
  { src: "/images/raized-wrong.jpg", download: "/images/full/raized-wrong.png", alt: "Raized Wrong — Louder Than Yesterday tour poster", title: "Raized Wrong — Louder Than Yesterday", medium: "Tour poster", project: "Raized Wrong", description: "Tour poster for the Louder Than Yesterday run — type-led, built to read at a distance and survive being stapled to a pole.", ratio: "portrait" },
  ...
  { src: "/images/brothers.jpg", download: "/images/full/brothers.png", alt: "Brothers — early concept work", title: "Brothers", medium: "Concept work", description: "Early concept work, kept here as a marker of where the visual language started.", ratio: "tall" },
  ...
  { src: "/images/vultures3.jpg", download: "/images/full/vultures3.jpg", alt: "Vultures 3 — album cover", title: "Vultures 3", date: "June 2026", medium: "Concept album cover", description: "Concept cover — stark, near-monochrome, built around a single central figure.", ratio: "square" },
  { src: "/images/selfactualize.jpg", download: "/images/full/selfactualize.png", alt: "Self Actualize — album cover", title: "Self Actualize", date: "July 2026", medium: "Concept album cover", description: "Concept cover exploring self-image through layered photographic treatment.", ratio: "square" },
  { src: "/images/bbpb.jpg", download: "/images/full/bbpb.png", alt: "BBPB — album cover", title: "BBPB", date: "January 2026", medium: "Concept album cover", description: "Concept cover — a square composition worked entirely in Photoshop.", ratio: "square" },
  { src: "/images/doomsday.jpg", download: "/images/full/doomsday.png", alt: "Doomsday — poster", title: "Doomsday", date: "July 2026", medium: "Concept film poster", description: "Concept one-sheet — full billing block, title treatment and key art built to the proportions of a real theatrical poster.", ratio: "poster" },
  { src: "/images/google.png", download: "/images/full/google.png", alt: "Google — concept visual", title: "Google — Redesign", date: "March 2026", medium: "Identity concept", description: "Identity concept: the wordmark rebuilt so the search field becomes the second o, set on a full-spectrum gradient.", ratio: "banner" },
  { src: "/images/agr30hr2.jpg", download: "/images/full/agr30hr2.png", alt: "AGR 30HR2 — 30 Hour Weekend stream art", title: "AUGER — 30 Hour Weekend", date: "October 2025", medium: "Stream key art", project: "AUGER", description: "Key art for a 30-hour charity stream weekend — blackletter title, portrait inset, and the broadcast dates set large.", ratio: "banner" },
];
