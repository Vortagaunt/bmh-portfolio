    ...
    <main className="relative isolate min-h-screen w-full bg-[#f1f1f1] text-[#181818]">
      ...
      <div className="relative z-10 flex min-h-[calc(100vh-64px)] flex-col items-center justify-center px-5 pb-24 sm:px-8">
        ...
        <Reveal variant="scale" delay={150} duration={1200}>
          <div
            className="relative w-[min(92vw,560px)] border-2 border-[#181818] bg-white"
          ...
          >
            ...
            <div className="flex items-start gap-5 p-6 sm:p-8">
              ...
              <svg viewBox="0 0 48 48" className="h-12 w-12 shrink-0" aria-hidden>
                <circle cx="20" cy="30" r="14" fill="#181818" />
                <rect x="26" y="12" width="7" height="7" fill="#181818" transform="rotate(35 29 15)" />
                <path d="M33 13 C37 8, 42 8, 44 12" fill="none" stroke="#181818" strokeWidth="2.5" strokeLinecap="round" />
                <g stroke="#181818" strokeWidth="2" strokeLinecap="round">
                  <line x1="44" y1="7" x2="44" y2="10" />
                  <line x1="41" y1="9" x2="43" y2="11" />
                  <line x1="47" y1="9" x2="45" y2="11" />
                </g>
                <circle cx="15" cy="25" r="4" fill="#f1f1f1" opacity=".9" />
              </svg>
              <div className="flex-1">
                <p className="text-[16px] leading-[1.5] text-[#181818]">
                  Sorry, a system error occurred.
                </p>
                <p className="mt-2 text-[14px] leading-[1.5] text-[#181818]/70">
